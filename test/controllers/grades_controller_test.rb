...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { assignment_name: @grade.assignment_name, date_due: @grade.date_due, grade: @grade.grade, student_id: @grade.student_id }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { assignment_name: @grade.assignment_name, date_due: @grade.date_due, grade: @grade.grade, student_id: @grade.student_id }
    assert_redirected_to grade_path(assigns(:grade))
  end
